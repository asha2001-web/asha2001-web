...
<input type ="hidden" name ='lastAcessModule' value="">
	<div class="header-inner">
		...
		<span class="name desk" style="color:#00ffe9; font-weight:block">National Aviation Security Fee Trust (NASFT<%=jvcString%>) </span>
		...
		<ul class="nav navbar-nav pull-right">
			<li class="language"></li>
	  		...
	  		<li class="dropdown user">
				...
				{
					%>
						<li><a href="<%=appContext%>/ASFJVC"><i class="fa fa-key"></i> Log Out</a></li>
					<%
				}
				else
				{
