...
menu="/ASF/js/MenuJS/ASFDBMenu_En.jsp?menu="+session.getAttribute("menu");
System.out.println("menumenumenumenu"+menu);

%>
 <jsp:include page="/view/common/LocaleCommonCode.jsp" />
   <jsp:include page="/ASF/ASFDBHeader.jsp"  />
   <jsp:include page="<%=menu %>"  />
	<jsp:include page="<%=varpath %>" > </jsp:include >
    <jsp:include page="/ASF/ASFDBFooter.jsp" />
