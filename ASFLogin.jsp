...
var encrypted = CryptoJS.AES.encrypt(pp, ec);

var decrypted = CryptoJS.AES.decrypt(encrypted,ec);

document.frmAimsLogin.pwd.value=encrypted;
...

{
	...
	if(document.frmAimsLogin.pwd.value!="")
	{
	var pp =document.frmAimsLogin.pwd.value;
...
<header class="header navbar navbar-inverse navbar-fixed-top">
    ...
    &nbsp; &nbsp; <img src="ASF/images/logo-for-banner.png" alt="" style="width:45px;height:40px">
        <span class="name-inner">
          <span style="color:#00ffe9; font-weight:block"> <b>National Aviation Security Fee Trust -<span style="color:#fff"> NASFT </span></b></span> 
        </span>
        <span class="name-inner"></span>
    <ul class="nav navbar-nav pull-right">
		<li  style="font-size: 14px; color:#fff; margin-top: -4px;">
 
		<a href="#" onclick="myFunction()" style="font-size: 14px; color:#fff;"> <img alt="" src="ASF/images/terms.png" style="margin-top: -8px;"  title="Terms and Conditions"> <span style="font-size: 10px; top: -4px; position: relative;">Terms & Conditions</span></a> </li>
...
<!--  class="login-form" -->
	<form  name="frmAimsLogin" onsubmit="return save('<%=encryptCode%>');" action="<%=appContext%>/ASF/ASFAirport.jsp"   method="post">
	<!--	<h3 class="form-title">Welcome to</h3>-->
		<img src="ASF/images/logo-for-login.png" alt="">
	<div style="width: 100%; padding-bottom: 10px" id="HeadingHLine"></div>
...
<div class="col-md-12" style="position:fixed; bottom: 0px !important; text-align: justify; background: linear-gradient(to bottom, #02599C 0%, #012D4A 100%); right: 0px !important; color: #ffffff">
  ...
  <h5>  &nbsp;  &nbsp;  &nbsp; <b><i class='fa fa-phone	 faa-tada animated fa-4x'></i> &nbsp; Support   Helplines  : </b>  +91 90007 19888 , +91 98668 19888 and +91 90324 06161</h5> 
     ...
     <h5> <b><i class='fa fa-envelope faa-horizontal animated'></i>  &nbsp; email id  : </b> aimssupport@navayuga.com</h5>
     </div> 
