...
<% 
 ...
 strQuery = " select sysdate-nvl(Last_Password_Changed_Date,sysdate-180) Password_Changed_Date from am_user_mt where usrid=? and  usrid not in ('00001','00003','00002') "; 
...
try
{
   ...
   passwordExp=dbaccess.getRecordSetWithPrepared(strQuery,sessionBean.getUserId());
   if(passwordExp!=null)
	{
		if(passwordExp.next())
		{
